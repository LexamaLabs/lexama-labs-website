      ...
      <section className="py-20 px-6 bg-gray-50 border-y border-gray-100">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white border border-gray-100 rounded-xl p-8 shadow-sm">
            <p className="font-mono text-[10px] font-semibold uppercase tracking-[2px] text-[#2563EB] mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              >
                ...
                <h3 className="text-[#F1F5F9] font-semibold mb-2">{v.title}</h3>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {[1, 2, 3].map((i) => (
              ...
              >
                <div className="w-14 h-14 rounded-xl bg-[#3B82F6]/8 border border-[#3B82F6]/15 mb-4 flex items-center justify-center">
                  <span className="text-[#3B82F6] text-lg font-bold">?</span>
                </div>
